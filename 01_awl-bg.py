...
def airbyte_create_connection(**kwargs):
    ...
    source_id = ab.get_source_by_name(workspace_id=workspace_id, source_name=dag_clean_name)
    if not source_id:
    ...
    destination_id = ab.get_destination_by_name(workspace_id=workspace_id, destination_name=dag_clean_name)
